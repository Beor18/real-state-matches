  ...
  zillow_bridge: {
    ...
    fields: [
      ...
      },
      {
        ...
        type: 'text',
        required: true,
        placeholder: 'stellar, actris, crmls, test...',
        description: 'Identificador del MLS al que tienes acceso',
      },
      {
        key: 'default_state',
        label: 'Estado/Provincia por defecto',
        type: 'text',
        required: false,
        placeholder: 'PR, FL, TX...',
        description: 'Filtro por defecto de StateOrProvince. Dejar vacío para no filtrar por estado.',
      },
      {
        key: 'default_mls_status',
        label: 'MLS Status por defecto',
        type: 'select',
        required: false,
        description: 'Status MLS por defecto para filtrar propiedades. Si no se selecciona, se usa "Active".',
        options: [
          { value: 'Active', label: 'Active (Activas)' },
          { value: 'Pending', label: 'Pending (Pendientes)' },
          { value: 'Closed', label: 'Closed (Cerradas)' },
        ],
      },
    ],
  },
