...
import { LucideIcon, CreditCard, Search, LayoutDashboard, Home, FileText, HelpCircle } from 'lucide-react'
...
export const PAGES: Record<string, PageConfig> = {
  ...
  'page-buscar': {
    ...
    description: 'Permite a los usuarios buscar propiedades con IA',
    route: '/buscar',
    icon: Search,
