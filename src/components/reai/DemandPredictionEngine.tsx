    ...
    setZones([
      ...
      },
      {
        ...
        keyFactors: [
          ...
          "Desarrollo de Residencias de lujo",
        ],
      },
      {
        id: "3",
    ...
    <div className="space-y-6">
      ...
      >
        ...
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Analiza zonas infravaloradas, patrones migratorios y el sentimiento de
          nuestra comunidad de 315k+ fans para predecir tendencias del mercado
          inmobiliario en Puerto Rico y Latam
        </p>
      </motion.div>
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center gap-4">
              ...
              <div className="flex-1 space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Analizando 1,247 propiedades, 23 zonas, y patrones migratorios
                  de 315k+ usuarios en tiempo real
                </p>
              </div>
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center gap-2">
                          ...
                          {zone.isUndervalued && (
                            <Badge
                              variant="outline"
                              className="gap-1 border-emerald-500 text-emerald-700"
                            >
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-muted-foreground">
                          {zone.migrationTrend === "influx" &&
                            "Afluencia de residentes nueva"}
                          {zone.migrationTrend === "stable" && "Estable"}
                          {zone.migrationTrend === "outflow" &&
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center justify-between text-sm">
                        ...
                        <span className="font-medium">
                          {(zone.fanbaseSentiment * 100).toFixed(0)}% Positivo
                        </span>
                      </div>
                      <div className="h-2 bg-muted rounded-full overflow-hidden">
                        <motion.div
                          ...
                          className={`h-full ${
                            zone.fanbaseSentiment > 0.7
                              ? "bg-gradient-to-r from-emerald-500 to-emerald-400"
                              : zone.fanbaseSentiment > 0.4
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <span className="font-bold text-lg text-emerald-600">
                          +$
                          {(
                            property.predictedValue3Y - property.price
                      ...
                      <div className="space-y-1">
                        <div className="flex items-center justify-between text-xs">
                          ...
                          <span className="text-emerald-600">
                            +
                            {Math.round(
                              ((property.predictedValue1Y - property.price) /
                                property.price) *
                                100,
                            )}
                            %
