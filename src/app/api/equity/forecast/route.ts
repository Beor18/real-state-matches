  ...
  try {
    ...
    const mockForecast = {
      ...
      equityData: [
        ...
        {
          year: "Año 1",
          propertyValue: 543200,
          equity: 380240,
          loanBalance: 162960,
        },
        {
          year: "Año 3",
          propertyValue: 620800,
          equity: 434560,
          loanBalance: 186240,
        },
        {
          year: "Año 5",
          propertyValue: 783500,
          equity: 548450,
          loanBalance: 235050,
        },
        {
          year: "Año 10",
          propertyValue: 1242000,
          equity: 869400,
          loanBalance: 372600,
        },
      ],
      remodelTips: [
        {
          ...
          description:
            "Piscina infinita con vista al mar, aumentará significativamente el valor de la propiedad en zona turística",
          estimatedCost: 85000,
          estimatedRoi: 120,
          priority: "high",
          timeframe: "6-8 meses",
        },
        {
          ...
          description:
            "Cocina de lujo con isleta central y electrodomésticos de alta gama",
          estimatedCost: 45000,
          estimatedRoi: 85,
          priority: "medium",
          timeframe: "3-4 meses",
